...
######################################################################################################################################
#curl -X POST http://127.0.0.1:5000/account/12/transfer -H "Content-Type: application/json" -d '{"amount": 5.5,"currency": "EUR","label": "Virement Maman","recipient": 2}'
